		...
		<div className="mt-5">

			{
				showData === true ? (
						...
						<div className="card mb-3 mx-auto bg-dark text-light">
							<div className="row g-0">
								<div className="col-md-4">
									...
									<img src="https://images.pexels.com/photos/15279643/pexels-photo-15279643.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="img-fluid rounded-start altura" alt=".." />
								</div>
								<div className="col-md-8">
									<div className="card-body text-start mt-2">
										<h5 className="card-text">Temperatura máxima: {(weather.main.temp_max - 273.15).toFixed(1)}°C</h5>
										<h5 className="card-text">Temperatura min: {(weather.main.temp_min - 273.15).toFixed(1)}°C</h5>
					...
					<h2 className="text-dark">Created by JohanaMartinezWeb</h2>
				)
			}
